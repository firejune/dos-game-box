...
/* memory initializer */ allocate([70,97,105,108,101,100,32,116,111,32,108,111,97,100,32,114,101,115,111,117,114,99,101,115,10,0,0,0,0,0,0,0,72,101,108,108,111,32,87,111,114,108,100,0,0,0,0,0], "i8", ALLOC_NONE, Runtime.GLOBAL_BASE);
...
var FUNCTION_TABLE = [0,0,__ZL18update_fade_factorv,0,__ZL6renderv,0];
...
function _main($argc,$argv){
 ...
 _glutInitWindowSize(400,300);
 var $5=_glutCreateWindow(40);
 _glutDisplayFunc(4);
 _glutIdleFunc(2);
 var $6=_glewInit();
 var $7=__ZL14make_resourcesv();
 var $8=($7|0)!=0;
 if($8){label=3;break;}else{label=2;break;}
 case 2: 
 var $10=HEAP32[((_stderr)>>2)];
 var $11=_fprintf($10,8,(tempVarArgs=STACKTOP,STACKTOP = (STACKTOP + 1)|0,STACKTOP = (((STACKTOP)+7)&-8),(assert((STACKTOP|0) < (STACK_MAX|0))|0),HEAP32[((tempVarArgs)>>2)]=0,tempVarArgs)); STACKTOP=tempVarArgs;
 $1=1;
 label=4;break;
 case 3: 
 _glutMainLoop();
...
function __ZL6renderv(){
 var label=0;


 _glClearColor(0,1,0,1);
 _glClear(16384);
...
function __ZL18update_fade_factorv(){
 var label=0;
...
function __ZL14make_resourcesv(){
 var label=0;
